...
```txt
Your daily vehicle verification, ready before your first ride.
```

French:

```txt
Votre verification quotidienne, prete avant votre premiere course.
```
...
```txt
I'm a Quebec rideshare driver. After a costly issue with not having my daily verification report ready, I built a small app so drivers can remember, complete, and show their daily report quickly. Looking for 10 drivers to test it free.
```
