...
- During the redesign, `origin/main` advanced to
  `2bd12e1 feat(admin): add traceable session controls` while
  `origin/phase-21-production-alignment` remained at `3957d56`. A pre-rebase
  rollback branch/tag `backup/dashboard-redesign-pre-rebase-20260525-202820`
  was pushed, then `phase-21q-dashboard-redesign` was rebased cleanly onto
  `origin/main`.
...
| Public trust pages safe-gap review | `docs/readiness/PHASE_21O_PUBLIC_TRUST_PAGES_AND_SAFE_GAP_REVIEW.md` |
...
| Commercial terms status | `docs/business/PILOT_TERMS_DECISION_GATE.md` |
| Public trust pages safe-gap review | `docs/readiness/PHASE_21O_PUBLIC_TRUST_PAGES_AND_SAFE_GAP_REVIEW.md` |
...
```text
Production-deployed on 2026-05-25 (main at f4a8337 before the safe-gap push / https://bizpilo.com).
