    ...
    >
      ...
      <div className="grid gap-3 xl:grid-cols-[0.92fr_1.08fr] xl:items-start">
        ...
        >
          ...
          <div className="mt-2 space-y-1.5 text-[11px] leading-[1.65]" style={{ color: marketingTone.soft }}>
          ...
          <div className="mt-3 grid gap-2">
            <MarketingButton className="h-8 w-full text-[11px]" href="/auth/sign-up">
              {copy.reviewReply}
            </MarketingButton>
          </div>
        </div>
      ...
      <MarketingShell>
        <div className="grid min-w-0 items-center gap-8 lg:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)]">
          <div className="min-w-0">
            ...
            <h1 className="mt-4 max-w-[580px] text-[32px] font-black leading-[1.05] min-[380px]:text-[36px] sm:text-[40px] xl:text-[44px]" style={{ color: marketingTone.text }}>
              {copy.hero.title}
            </h1>
            <p className="mt-4 max-w-[560px] text-[14.5px] leading-7 sm:text-[15.5px] sm:leading-[1.75]" style={{ color: marketingTone.soft }}>
              {copy.hero.body}
            </p>
            <div className="mt-5 grid gap-3 min-[430px]:flex min-[430px]:flex-wrap">
            ...
            <div className="mt-4 grid gap-2 text-[12.5px]" style={{ color: marketingTone.soft }}>
        ...
        >
          <div className="grid gap-7 lg:grid-cols-[minmax(0,0.94fr)_88px_minmax(0,1.06fr)] lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-[24px] font-black leading-tight sm:text-[32px]" style={{ color: marketingTone.text }}>
                {copy.beforeTitle}
              </h2>
