...
const englishPublicSiteCopy: PublicSiteCopy = {
  ...
  home: {
    ...
    mockup: {
      ...
      chaosBadge: "10 owner inbox PMs",
      chaosHint: "Different people, channels, and details piling up at once.",
...
const frenchPublicSiteCopy: PublicSiteCopy = {
  ...
  home: {
    ...
    mockup: {
      ...
      bizPilotTitle: "BizPilot",
      chaosBadge: "10 messages dans la boîte du propriétaire",
      chaosHint: "Plusieurs personnes, canaux et détails s'accumulent en même temps.",
